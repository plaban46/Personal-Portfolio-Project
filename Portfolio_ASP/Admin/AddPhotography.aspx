<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeBehind="AddPhotography.aspx.cs" Inherits="Portfolio_ASP.Admin.AddPhotography" %>
        ...
        <div class="col-sm-12">
            <div class="table table-responsive">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PortfolioCon %>"
                    DeleteCommand="DELETE FROM [AddPhotography] WHERE [IID] = @IID" InsertCommand="INSERT INTO [AddPhotography] ([IName], [Image]) VALUES (@IName, @Image)"
                    SelectCommand="SELECT [IID], [IName], [Image] FROM [AddPhotography]"
                    UpdateCommand="UPDATE [AddPhotography] SET [IName] = @IName, [Image] = @Image WHERE [IID] = @IID">
                    <DeleteParameters>
