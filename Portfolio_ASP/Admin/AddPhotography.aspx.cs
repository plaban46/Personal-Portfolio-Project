...
{
    public partial class AddPhotography : System.Web.UI.Page
    {
        ...
        protected void btnAddItem_Click(object sender, EventArgs e)
        {
            if (IsFormValidate())
            {
                ...
                SqlCommand cmd = new SqlCommand("insert into AddPhotography(IName,Image) values(@NAME,@IMg)", con);
                ...
                cmd.ExecuteNonQuery();
                con.Close();
                Response.Write("<script>alert('Photography added successfully');</script>");
